...
mod test_trace_store {
    use super::*;
    use infer_inference::{TraceNode, TraceStore, TraceWriter};
...
mod test_boundary_store {
    use super::*;
    use infer_inference::{BoundaryStore, BoundaryWriter};
...
mod test_context_store {
    use super::*;
    use infer_inference::{ContextStore, ContextTier, ContextWriter};
