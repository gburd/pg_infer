...
//!
//! Usage:
//!   cargo run --release -p infer-inference --example ffn_cache_demo -- \
//!     --model google/gemma-3-4b-it \
//!     --vindex path/to/gemma3-4b.vindex

use std::time::Instant;

use infer_inference::{vindex::WalkFfn, InferenceModel};
use infer_inference::ffn::FfnBackend;
use infer_vindex::{PatchedVindex, SilentLoadCallbacks, VectorIndex};
use ndarray::Array2;
