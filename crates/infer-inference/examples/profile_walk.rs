...
//!
//! Usage:
//!   cargo run --release -p infer-inference --example walk_profile -- \
...
use infer_vindex::{SilentLoadCallbacks, VectorIndex};
...
fn walk_loop(
    index: &VectorIndex,
    weights: &infer_inference::ModelWeights,
    layer: usize,
    x: &Array2<f32>,
    hits: &[(usize, f32)],
) -> Array2<f32> {
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  {:-<84}", "");
    use infer_inference::vindex::WalkFfnConfig;
