...
//!
//! Usage:
//!   cargo run --release -p infer-compute --features metal --example bench_full_pipeline
...
fn main() {
    ...
    #[cfg(feature = "metal")]
    {
        use infer_compute::metal::MetalBackend;
        use infer_compute::metal::ops::full_pipeline::LayerWeights;
