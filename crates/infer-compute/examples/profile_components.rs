...
fn main() {
    ...
    #[cfg(feature = "metal")]
    {
        ...
        use infer_compute::metal::shaders::q4k_qkv_proj as qkv_sh;
        use infer_compute::metal::shaders::q4_matvec as q4mv;
        ...
        let norm_ms = bench!("rms_norm", {
            ...
            for _ in 0..layers {
                ...
                infer_compute::metal::ops::full_pipeline::encode_rms_norm(
