...
//! generic solve underlying `infer_vindex::memit_solve`).
//!
//! Run: `cargo bench -p infer-compute --bench linalg`

extern crate blas_src;

use criterion::{criterion_group, criterion_main, BenchmarkId, Criterion};
use infer_compute::cpu::ops::linalg::{cholesky, cholesky_solve, ridge_decomposition_solve};
use ndarray::Array2;
