...
/// `infer_models::quant::ggml::dequantize_q4_k`, and decodes identically
...
mod tests {
    ...
    /// don't take a dev-dep on `infer-models` just to verify the format.
    ...
    #[test]
    fn q4_k_round_trip_matches_infer_models_decoder() {
        // Cross-check against the authoritative decoder in infer-models.
        ...
        let decoded = infer_models::quant::ggml::dequantize_q4_k(&bytes, 256 * 3)
