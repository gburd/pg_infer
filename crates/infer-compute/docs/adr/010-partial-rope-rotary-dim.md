...
3. **CPU path already complete** — `apply_rope_partial()` in infer-inference handles partial rotation on CPU. The Metal shaders match this behavior for GPU acceleration.
