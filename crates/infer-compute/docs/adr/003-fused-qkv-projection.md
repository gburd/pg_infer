...
- **q8_qkv_proj**: Original infer design. Simdgroup Q8×Q8 integer dot product with shared Q8 input in threadgroup memory. 2.2x faster than 3 separate dispatches.
- **q4k_qkv_proj**: Original infer design. Same fused pattern for Q4_K data with sub-block lane assignment (80 sub-blocks / 32 lanes = 83% utilization).
