# Metal Shader Reference — infer-compute
...
Origin: infer original, iterative optimization from v1-v3.
...
Origin: infer original, rewritten 2026-04-08 with uint4+nr0 optimizations.
...
Origin: infer original. Sub-block iteration is novel; direct device reads inspired by llama.cpp.
...
Origin: infer original (2026-04-09).
...
Origin: infer original (2026-04-08).
...
Origin: infer original (2026-04-08). Kept for documentation of the failed experiment.
...
Origin: infer original, matching GGUF Q6_K dequantization formula.
...
Origin: infer original. See [ADR-007](adr/007-fused-attention-skip-rope.md) and [ADR-010](adr/010-partial-rope-rotary-dim.md).
...
Origin: infer original. SIMD cooperative reduction added 2026-04-09.
