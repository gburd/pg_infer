...
pub trait WeightSource {
    ...
    fn arch(&self) -> &dyn infer_models::ModelArchitecture;
...
pub struct StreamingWeights<'a> {
    ...
    pub arch: &'a dyn infer_models::ModelArchitecture,
...
pub fn write_model_weights_q4k_with_opts(
    ...
    if arch.is_hybrid_moe() && arch.expert_format() == infer_models::ExpertFormat::PackedBF16 {
