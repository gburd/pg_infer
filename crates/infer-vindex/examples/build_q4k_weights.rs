...
//!
//! IMPORTANT: Uses infer_compute::cpu::ops::q4_common quantizers as single source of truth.
//! This ensures the format matches what the Metal/CPU kernels expect.
//!
//! Usage:
//!   cargo run --release -p infer-vindex --example build_q4k_weights -- <vindex_dir>
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  Using infer_compute quantizers (single source of truth)\n");
