...
**Status**: Accepted  
**Date**: 2026-03  
**Context**: Traditional inference loads all weights into RAM. infer needs selective access to individual features.
...
Original infer design. No known prior art for treating transformer FFN weights as a queryable database format.
