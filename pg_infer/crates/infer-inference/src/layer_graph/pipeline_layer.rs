...
pub fn build_arch_params<'a>(
    ...
    FullPipelineLayer {
        ...
        norm_type: match arch.norm_type() {
            infer_models::NormType::LayerNorm => infer_compute::NormType::LayerNorm,
            _ => infer_compute::NormType::RmsNorm,
        },
        ffn_type: match arch.ffn_type() {
            infer_models::FfnType::Standard => infer_compute::FfnType::Standard,
            _ => infer_compute::FfnType::Gated,
        },
