...
//!
//! Usage:
//!   cargo run --release -p infer-inference --example bench_layer_graph -- \
...
use infer_inference::vindex::WalkFfn;
...
fn bench(
    ...
    token_ids: &[u32],
    graph: &dyn infer_inference::LayerGraph,
    n: usize,
) -> (String, f64, f64) {
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    {
        use infer_inference::layer_graph::predict::{prefill_with_kv, finalize_logits};
...
fn check_norms(weights: &infer_inference::ModelWeights) {
