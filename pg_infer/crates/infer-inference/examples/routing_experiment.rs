...
//!
//! Usage:
//!   cargo run --release -p infer-inference --example routing_experiment

use std::collections::HashSet;
use infer_inference::{InferenceModel, WeightFfn};
use infer_inference::forward::trace_forward_full;
...
fn flatten_attn(weights: &infer_inference::attention::AttentionWeights) -> Vec<f32> {
