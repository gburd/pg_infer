...
**Status**: Accepted  
**Date**: 2026-03  
**Context**: Need a unified way to describe model architectures (tensor keys, norms, scaling, attention patterns) that works across all infer crates without introducing compute dependencies.
...
- **Good**: Zero compute dependency — `infer-models` has no BLAS, Metal, or math imports.
