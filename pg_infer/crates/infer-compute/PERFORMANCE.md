# Performance Tracking — infer-compute
...
```
infer Q4_KF decode (34 layers, KV cache):   8.5ms = 117 tok/s  ← synthetic ceiling
Ollama gemma3:4b (34 layers):              10.3ms =  98 tok/s
vs Ollama (synthetic):                     0.83x (17% FASTER)
```

### Real vindex (infer bench, gemma3-4b-q4k-v2.vindex, M3 Max, 2026-04-19)
```
...
## What infer Has That Ollama Doesn't

| Feature | Ollama | infer |
|---------|--------|-------|
