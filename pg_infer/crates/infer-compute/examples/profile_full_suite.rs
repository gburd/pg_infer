//! Full benchmark suite for infer-compute.
//!
...
//!
//! Usage:
//!   cargo run --release -p infer-compute --example bench_full
//!   cargo run --release -p infer-compute --features metal --example bench_full
...
fn main() {
    ...
    println!("=== infer-compute Full Benchmark Suite ===");
    ...
    #[cfg(feature = "metal")]
    {
        if let Some(ref metal) = infer_compute::metal::MetalBackend::new() {
