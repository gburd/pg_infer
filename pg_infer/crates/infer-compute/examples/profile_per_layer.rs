...
fn main() {
    ...
    #[cfg(feature = "metal")]
    {
        ...
        use infer_compute::cpu::ops::q4_common::{quantize_q4_k, quantize_q4_0};

        let metal = infer_compute::default_backend();
        let n = 50;
        ...
        for &num_layers in &[1usize, 21] {
            ...
            let layers: Vec<infer_compute::FullPipelineLayer> = layers_data.iter().map(|(wq,wk,wv,wo,g,u,d,norm)| {
                infer_compute::FullPipelineLayer {
                    ...
                    gate: infer_compute::QuantWeight { data: g, scales: None, format: infer_compute::QuantFormat::Q4_0 },
                    up: infer_compute::QuantWeight { data: u, scales: None, format: infer_compute::QuantFormat::Q4_0 },
                    down: infer_compute::QuantWeight { data: d, scales: None, format: infer_compute::QuantFormat::Q4_0 },
