...
//!
//! Usage: cargo run --release --features metal -p infer-compute --example bench_q4kf_decode
...
fn main() {
    ...
    #[cfg(feature = "metal")]
    {
        ...
        use infer_compute::cpu::ops::q4_common::{quantize_q4_k, quantize_q4_0, q4k_to_q4kf};
        ...
        // ── Q4_KF decode ──
        let q4kf_layers: Vec<infer_compute::FullPipelineLayer> = layers_data.iter().map(|ld| {
            infer_compute::FullPipelineLayer {
                wq: infer_compute::QuantWeight { data: &ld.wq_q4kf, scales: None, format: infer_compute::QuantFormat::Q4_KF },
                wk: infer_compute::QuantWeight { data: &ld.wk_q4kf, scales: None, format: infer_compute::QuantFormat::Q4_KF },
                wv: infer_compute::QuantWeight { data: &ld.wv_q4kf, scales: None, format: infer_compute::QuantFormat::Q4_KF },
                wo: infer_compute::QuantWeight { data: &ld.wo_q4kf, scales: None, format: infer_compute::QuantFormat::Q4_KF },
                gate: infer_compute::QuantWeight { data: &ld.gate_q4, scales: None, format: infer_compute::QuantFormat::Q4_0 },
                up: infer_compute::QuantWeight { data: &ld.up_q4, scales: None, format: infer_compute::QuantFormat::Q4_0 },
                down: infer_compute::QuantWeight { data: &ld.down_q4, scales: None, format: infer_compute::QuantFormat::Q4_0 },
        ...
        // ── Q4_K decode ──
        let q4k_layers: Vec<infer_compute::FullPipelineLayer> = layers_data.iter().map(|ld| {
            infer_compute::FullPipelineLayer {
                wq: infer_compute::QuantWeight { data: &ld.wq_q4k, scales: None, format: infer_compute::QuantFormat::Q4_K },
                wk: infer_compute::QuantWeight { data: &ld.wk_q4k, scales: None, format: infer_compute::QuantFormat::Q4_K },
                wv: infer_compute::QuantWeight { data: &ld.wv_q4k, scales: None, format: infer_compute::QuantFormat::Q4_K },
                wo: infer_compute::QuantWeight { data: &ld.wo_q4k, scales: None, format: infer_compute::QuantFormat::Q4_K },
                gate: infer_compute::QuantWeight { data: &ld.gate_q4, scales: None, format: infer_compute::QuantFormat::Q4_0 },
                up: infer_compute::QuantWeight { data: &ld.up_q4, scales: None, format: infer_compute::QuantFormat::Q4_0 },
                down: infer_compute::QuantWeight { data: &ld.down_q4, scales: None, format: infer_compute::QuantFormat::Q4_0 },
                input_norm: &ld.norm, post_attn_norm: &ld.norm,
        ...
        let gguf_layers: Vec<infer_compute::FullPipelineLayer> = layers_data.iter().map(|ld| {
            infer_compute::FullPipelineLayer {
                wq: infer_compute::QuantWeight { data: &ld.wq_gguf, scales: None, format: infer_compute::QuantFormat::Q4_KF },
                wk: infer_compute::QuantWeight { data: &ld.wk_gguf, scales: None, format: infer_compute::QuantFormat::Q4_KF },
                wv: infer_compute::QuantWeight { data: &ld.wv_gguf, scales: None, format: infer_compute::QuantFormat::Q4_KF },
                wo: infer_compute::QuantWeight { data: &ld.wo_gguf, scales: None, format: infer_compute::QuantFormat::Q4_KF },
                gate: infer_compute::QuantWeight { data: &ld.gate_q4, scales: None, format: infer_compute::QuantFormat::Q4_0 },
                up: infer_compute::QuantWeight { data: &ld.up_q4, scales: None, format: infer_compute::QuantFormat::Q4_0 },
                down: infer_compute::QuantWeight { data: &ld.down_q4, scales: None, format: infer_compute::QuantFormat::Q4_0 },
                input_norm: &ld.norm, post_attn_norm: &ld.norm,
