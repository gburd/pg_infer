...
//! The underlying ridge-system solve is `infer_compute::cpu::ops::linalg::
...
//! `infer-inference/src/forward/memit.rs`.

use ndarray::{Array1, Array2};

use infer_compute::cpu::ops::linalg::ridge_decomposition_solve;
...
///
/// Wraps `infer_compute::cpu::ops::linalg::ridge_decomposition_solve`
...
/// edits with C⁻¹ whitening, use `infer-inference::forward::memit`.
pub fn memit_solve(
    keys: &Array2<f32>,
    targets: &Array2<f32>,
    lambda: f32,
